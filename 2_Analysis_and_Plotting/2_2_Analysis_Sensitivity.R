...
# Sensitivity - determine mathematically ----
# detection rate by sample method
...
write.csv(table_percent_detection_core, "./2_Analysis_and_Plotting/outputs/table_percent_detection_core.csv")

# Modeling Tropilaelaps sensitivity----
...
my_conn <- file("./2_Analysis_and_Plotting/outputs/paircomp_tropi_2026-02-08.RTF", "w")
writeLines(tbl.paircomp_tropi, my_conn)
close(my_conn)



# Modeling Varroa Sensitivity
# Analyze Varroa detection rate by sample method
...
my_conn <- file("./2_Analysis_and_Plotting/outputs/paircomp_varroa_2026-02-08.RTF", "w")
