#### Analysis of number of mite detections by different methods
...
# Mathematical mean number of detections of Tropilaelaps and Varroa ----
...
# Nice Varroa pairwise comparison table with gt ----
